...
cd apps/mini-app && zmp deploy                    # đẩy bản production lên Zalo
```

Sau đó vào [Zalo Mini App portal](https://mini.zalo.me) → chọn version → **gửi duyệt (review)** → khi duyệt xong
bấm **Publish**. Yêu cầu: liên kết **OA (Official Account)**, khai báo domain API vào whitelist, cấu hình
